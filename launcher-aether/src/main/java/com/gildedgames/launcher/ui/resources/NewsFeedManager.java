...
public class NewsFeedManager extends ImageCache {
	private static final String METADATA_URL = "https://helioss.co/launcher-packs/latest.json",
			IMAGE_PROVIDER_URL = "https://helioss.co/launcher-packs/launcher-images/";
